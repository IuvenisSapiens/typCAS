...
//       - defined: closure args(expr tuple) -> tuple<restriction-record>
//       - diff: closure args(expr tuple) -> tuple<restriction-record>
//       - integ: closure args(expr tuple) -> tuple<restriction-record>
...
/// Internal helper `_restriction`.
/// Kept local to avoid import cycles with `src/restrictions.typ`.
...
#let fn-registry = (
    ...
    restrictions: (
      defined: args => (
        _restriction(
          ...
          "fn:csc",
          "defined",
          "csc(u) is undefined when sin(u) = 0.",
        ),
      ),
      diff: args => (
        _restriction(
          ...
          "fn:csc",
          "diff",
          "Derivative form assumes sin(u) != 0.",
        ),
      ),
      integ: args => (
        _restriction(
          ...
          "fn:csc",
          "integ",
          "Antiderivative form assumes sin(u) != 0.",
        ),
      ),
    ),
    calculus: (
    ...
    restrictions: (
      defined: args => (
        _restriction(
          ...
          "fn:sec",
          "defined",
          "sec(u) is undefined when cos(u) = 0.",
        ),
      ),
      diff: args => (
        _restriction(
          ...
          "fn:sec",
          "diff",
          "Derivative form assumes cos(u) != 0.",
        ),
      ),
      integ: args => (
        _restriction(
          ...
          "fn:sec",
          "integ",
          "Antiderivative form assumes cos(u) != 0.",
        ),
      ),
    ),
    calculus: (
    ...
    restrictions: (
      defined: args => (
        _restriction(
          ...
          "fn:cot",
          "defined",
          "cot(u) is undefined when sin(u) = 0.",
        ),
      ),
      diff: args => (
        _restriction(
  ...
  arcsin: (
    ...
    restrictions: (
      defined: args => (
        _restriction(args.at(0), ">=", num(-1), "fn:arcsin", "defined", "Real-domain arcsin requires -1 <= u <= 1."),
        _restriction(args.at(0), "<=", num(1), "fn:arcsin", "defined", "Real-domain arcsin requires -1 <= u <= 1."),
      ),
      diff: args => (
        _restriction(args.at(0), ">", num(-1), "fn:arcsin", "diff", "Real-domain derivative requires -1 < u < 1."),
        _restriction(args.at(0), "<", num(1), "fn:arcsin", "diff", "Real-domain derivative requires -1 < u < 1."),
      ),
      integ: args => (),
    ),
  ...
  arccos: (
    ...
    restrictions: (
      defined: args => (
        _restriction(args.at(0), ">=", num(-1), "fn:arccos", "defined", "Real-domain arccos requires -1 <= u <= 1."),
        _restriction(args.at(0), "<=", num(1), "fn:arccos", "defined", "Real-domain arccos requires -1 <= u <= 1."),
      ),
      diff: args => (
        _restriction(args.at(0), ">", num(-1), "fn:arccos", "diff", "Real-domain derivative requires -1 < u < 1."),
        _restriction(args.at(0), "<", num(1), "fn:arccos", "diff", "Real-domain derivative requires -1 < u < 1."),
      ),
      integ: args => (),
    ),
  ...
  arccsc: (
    ...
    restrictions: (
      defined: args => (
        _restriction(abs-of(args.at(0)), ">=", num(1), "fn:arccsc", "defined", "Real-domain arccsc requires |u| >= 1."),
      ),
      diff: args => (
        _restriction(abs-of(args.at(0)), ">", num(1), "fn:arccsc", "diff", "Real-domain derivative requires |u| > 1."),
      ),
      integ: args => (),
    ),
    calculus: (
  ...
  arcsec: (
    ...
    restrictions: (
      defined: args => (
        _restriction(abs-of(args.at(0)), ">=", num(1), "fn:arcsec", "defined", "Real-domain arcsec requires |u| >= 1."),
      ),
      diff: args => (
        _restriction(abs-of(args.at(0)), ">", num(1), "fn:arcsec", "diff", "Real-domain derivative requires |u| > 1."),
      ),
      integ: args => (),
    ),
    calculus: (
    ...
    restrictions: (
      defined: args => (
        _restriction(
          ...
          "fn:csch",
          "defined",
          "csch(u) is undefined when sinh(u) = 0.",
        ),
      ),
      diff: args => (
        _restriction(
          ...
          "fn:csch",
          "diff",
          "Derivative form assumes sinh(u) != 0.",
        ),
      ),
      integ: args => (
        _restriction(
          ...
          "fn:csch",
          "integ",
          "Antiderivative form assumes sinh(u) != 0.",
        ),
      ),
    ),
    calculus: (
    ...
    restrictions: (
      defined: args => (
        _restriction(
          ...
          "fn:coth",
          "defined",
          "coth(u) is undefined when sinh(u) = 0.",
        ),
      ),
      diff: args => (
        _restriction(
  ...
  arccosh: (
    ...
    restrictions: (
      defined: args => (
        _restriction(args.at(0), ">=", num(1), "fn:arccosh", "defined", "Real-domain arccosh requires u >= 1."),
      ),
      diff: args => (
        _restriction(args.at(0), ">", num(1), "fn:arccosh", "diff", "Real-domain derivative requires u > 1."),
      ),
      integ: args => (),
    ),
    calculus: (
  ...
  arctanh: (
    ...
    restrictions: (
      defined: args => (
        _restriction(abs-of(args.at(0)), "<", num(1), "fn:arctanh", "defined", "Real-domain arctanh requires |u| < 1."),
      ),
      diff: args => (
        _restriction(abs-of(args.at(0)), "<", num(1), "fn:arctanh", "diff", "Real-domain derivative requires |u| < 1."),
      ),
      integ: args => (),
    ),
    calculus: (
  ...
  arccsch: (
    ...
    restrictions: (
      defined: args => (
        _restriction(args.at(0), "!=", num(0), "fn:arccsch", "defined", "Real-domain arccsch requires u != 0."),
      ),
      diff: args => (
        _restriction(args.at(0), "!=", num(0), "fn:arccsch", "diff", "Derivative form assumes u != 0."),
      ),
      integ: args => (),
    ),
    calculus: (
  ...
  arcsech: (
    ...
    restrictions: (
      defined: args => (
        _restriction(args.at(0), ">", num(0), "fn:arcsech", "defined", "Real-domain arcsech requires 0 < u <= 1."),
        _restriction(args.at(0), "<=", num(1), "fn:arcsech", "defined", "Real-domain arcsech requires 0 < u <= 1."),
      ),
      diff: args => (
        _restriction(args.at(0), ">", num(0), "fn:arcsech", "diff", "Real-domain derivative requires 0 < u < 1."),
        _restriction(args.at(0), "<", num(1), "fn:arcsech", "diff", "Real-domain derivative requires 0 < u < 1."),
      ),
      integ: args => (),
    ),
    calculus: (
  ...
  arccoth: (
    ...
    restrictions: (
      defined: args => (
        _restriction(abs-of(args.at(0)), ">", num(1), "fn:arccoth", "defined", "Real-domain arccoth requires |u| > 1."),
      ),
      diff: args => (
        _restriction(abs-of(args.at(0)), ">", num(1), "fn:arccoth", "diff", "Real-domain derivative requires |u| > 1."),
      ),
      integ: args => (),
    ),
    calculus: (
  ...
  ln: (
    ...
    restrictions: (
      defined: args => (
        _restriction(args.at(0), ">", num(0), "fn:ln", "defined", "ln(u) requires u > 0."),
      ),
      diff: args => (
        _restriction(args.at(0), ">", num(0), "fn:ln", "diff", "Derivative form assumes u > 0."),
      ),
      integ: args => (),
    ),
    calculus: (
  ...
  log2: (
    ...
    restrictions: (
      defined: args => (
        _restriction(args.at(0), ">", num(0), "fn:log2", "defined", "log2(u) requires u > 0."),
      ),
      diff: args => (
        _restriction(args.at(0), ">", num(0), "fn:log2", "diff", "Derivative form assumes u > 0."),
      ),
      integ: args => (),
    ),
    calculus: (
  ...
  log10: (
    ...
    restrictions: (
      defined: args => (
        _restriction(args.at(0), ">", num(0), "fn:log10", "defined", "log10(u) requires u > 0."),
      ),
      diff: args => (
        _restriction(args.at(0), ">", num(0), "fn:log10", "diff", "Derivative form assumes u > 0."),
      ),
      integ: args => (),
    ),
    calculus: (
  ...
  log1p: (
    ...
    restrictions: (
      defined: args => (
        _restriction(args.at(0), ">", num(-1), "fn:log1p", "defined", "log1p(u) requires u > -1."),
      ),
      diff: args => (
        _restriction(args.at(0), ">", num(-1), "fn:log1p", "diff", "Derivative form assumes u > -1."),
      ),
      integ: args => (),
    ),
    calculus: (
  ...
  abs: (
    ...
    restrictions: (
      defined: args => (),
      diff: args => (
        _restriction(args.at(0), "!=", num(0), "fn:abs", "diff", "d|u|/dx is undefined at u = 0."),
      ),
      integ: args => (),
    ),
    calculus: (
